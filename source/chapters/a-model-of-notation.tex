...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x103a37f10>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x103a37f10>'
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-6864abc11ba029a66187ba3bf7b4d680.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f1c13efda433ced0d22d51ab58030282.pdf}
\end{singlespacing}
\end{abjadbookoutput}
