...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x103948390>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x103948390>'
...
Traceback (most recent call last):
  ...
  File "/Users/josiah/Documents/Development/abjad/abjad/tools/scoretools/Container.py", line 1045, in append
    self.__setitem__(slice(len(self), len(self)), [component])
  File "/Users/josiah/Documents/Development/abjad/abjad/tools/scoretools/Container.py", line 217, in __setitem__
    return self._set_item(i, expr)
  File "/Users/josiah/Documents/Development/abjad/abjad/tools/scoretools/Container.py", line 560, in _set_item
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-92f892c73b19aa4062f33a23da587b0b.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.4]{assets/graphviz-7fa23c38398cf047780c7b5eda3baae0.pdf}
\end{singlespacing}
\end{abjadbookoutput}

\begin{comment}
<abjad>
spanner_one = spannertools.Spanner()
attach(spanner_one, staff.select_leaves())
graph(staff, spanner=spanner_one)
</abjad>
\end{comment}
...
>>> graph(staff, spanner=spanner_one)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.4]{assets/graphviz-ae3202ced0aa2cdc539e5b421d52a347.pdf}
\end{singlespacing}
\end{abjadbookoutput}

\begin{comment}
<abjad>
spanner_two = spannertools.Spanner()
attach(spanner_two, staff[:])
graph(staff, spanner=spanner_two)
</abjad>
\end{comment}
...
>>> graph(staff, spanner=spanner_two)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.4]{assets/graphviz-e58c75c72e6fdd3f9756f33564e2ac6d.pdf}
\end{singlespacing}
\end{abjadbookoutput}

\begin{comment}
<abjad>
spanner_three = spannertools.Spanner()
attach(spanner_three, measure_one[:] + measure_two[:])
graph(staff, spanner=spanner_three)
</abjad>
\end{comment}
...
>>> graph(staff, spanner=spanner_three)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.4]{assets/graphviz-67052171bbb4199bfd96eff88ae1ff5b.pdf}
\end{singlespacing}
\end{abjadbookoutput}

\begin{comment}
<abjad>
spanner_four = spannertools.Spanner()
attach(spanner_four, measure_one[1][:] + measure_two[0][:])
graph(staff, spanner=spanner_four)
</abjad>
\end{comment}
...
>>> graph(staff, spanner=spanner_four)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.4]{assets/graphviz-01a535f6ca05ef6d449b197c1298ef13.pdf}
\end{singlespacing}
\end{abjadbookoutput}
