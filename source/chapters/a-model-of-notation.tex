...
>>> show(pitch_segment)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-98c254b3bf3525db1108455a9eb836a7.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(transposition(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-749c176dfaf42985bd3b0d224300b46a.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(inversion(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-f5dccecbacdc176c5636cb8662091fbd.pdf}
\begin{lstlisting}
>>> inversion_with_axis = pitchtools.Inversion(axis=NamedPitch("d'"))
>>> show(inversion_with_axis(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-3788337f7ed0f9f5205ea317fef25ba7.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(retrogression(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-deb23384afe7501bded563186defeabd.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(untransposing_rotation(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-a64fe671be8f551e1d653f00a83a2e07.pdf}
\begin{lstlisting}
>>> transposing_rotation = pitchtools.Rotation(-1, transpose=True)
>>> show(transposing_rotation(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-7bd7aa6d7685f24919cad726cee57c04.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(multiplication(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-ea43de43da8ed2236bf38e48fab7ca25.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(pitch_operation(pitch_segment))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-0adc9e231ee227673c0a09c603241ec2.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
