...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x103932cd0>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x103932cd0>'
...
-   Back-port discussion about selecting by index, slice and name to container
    section
...
staff.extend(r"c'4 r4 c'4 ~ c'4 ~ \times 2/3 { c'8 r4 c'8 ~ } c'4 r4 c'4")
show(staff)
</abjad>
\end{comment}
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b4b0ff9ba945dc2a66384ba4499735a2.pdf}
\end{singlespacing}
\end{abjadbookoutput}
