...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x103a37fd0>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x103a37fd0>'
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-266c9ef72b67988b99a49392f1c189b7.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-1e712e48fed75449934558a26961651e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-61545fb4a90c75570950211838af52d0.pdf}
\end{singlespacing}
\end{abjadbookoutput}
