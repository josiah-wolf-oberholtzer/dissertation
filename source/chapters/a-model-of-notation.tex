...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x1039286d0>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x1039286d0>'
...
-   Demonstrate inspect_(...).get_indicator(), .get_indicators()

-   Demonstrate inspect_(...).has_indicator()
...
-   Demonstrate: inspect_(...).get_effective(), 
...
-   Demonstrate a non-formatting indication: attach(x, y, is_annotation=True)
