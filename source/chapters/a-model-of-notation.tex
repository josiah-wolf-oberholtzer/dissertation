...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x10393f150>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x10393f150>'
...
Traceback (most recent call last):
  ...
  File "/Users/josiah/Documents/Development/abjad/abjad/tools/scoretools/Container.py", line 927, in append
  ...
  File "/Users/josiah/Documents/Development/abjad/abjad/tools/scoretools/Container.py", line 442, in _set_item
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f2013d13a6d3ccee6cd663766ed29334.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
attach(pedal, staff.select_leaves())
show(staff)
</abjad>
\end{comment}
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-532e181dda2f750a2224d008539c767f.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
\begin{lstlisting}
>>> beam.components
Selection(Note("c'8"), Container("d'8 ef'8"), Note("f'8"))
\end{lstlisting}
\begin{lstlisting}
>>> slur.components
Selection(Container("d'8 ef'8"),)
\end{lstlisting}
\begin{lstlisting}
>>> hairpin.components
Selection(<Staff{3}>,)
...
\begin{lstlisting}
>>> pedal.components
Selection(Note("c'8"), Note("d'8"), Note("ef'8"), Note("f'8"))
\end{lstlisting}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(staff)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-16b6d94ab0e6aae2330a17a1aabbedfa.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
\begin{lstlisting}
>>> beam.components
Selection(Note("c'8"), Container("d'8 ef'8 f'8 g'8 a'8 bf'8"), Note("f'8"))
\end{lstlisting}
\begin{lstlisting}
>>> slur.components
Selection(Container("d'8 ef'8 f'8 g'8 a'8 bf'8"),)
\end{lstlisting}
\begin{lstlisting}
>>> hairpin.components
Selection(<Staff{3}>,)
...
\begin{lstlisting}
>>> pedal.components
Selection(Note("c'8"), Note("d'8"), Note("ef'8"), Note("f'8"), Note("g'8"), Note("a'8"), Note("bf'8"), Note("f'8"))
\end{lstlisting}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-24ab3daf3afa1d520cb45154b854055a.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
for count, rest in enumerate(iterator, start=1):
    ...
    markup = markup.pad_around(0.5).box().pad_around(0.5)
    attach(markup, rest)
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a84f2da91e622c60e9cd3b05b7b6b56e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
\begin{comment}
<abjad>
for component in iteration_agent.by_timeline():
    timespan = inspect_(component).get_timespan()
    print(component, timespan)
...
...     print(component, timespan)
...
(Note("d'4.."), Timespan(start_offset=Offset(0, 1), stop_offset=Offset(7, 16)))
(Rest('r8'), Timespan(start_offset=Offset(0, 1), stop_offset=Offset(1, 8)))
(Note("c'8"), Timespan(start_offset=Offset(1, 8), stop_offset=Offset(1, 4)))
(Rest('r8'), Timespan(start_offset=Offset(1, 4), stop_offset=Offset(3, 8)))
(Note('d8'), Timespan(start_offset=Offset(3, 8), stop_offset=Offset(1, 2)))
(Note("b'16"), Timespan(start_offset=Offset(7, 16), stop_offset=Offset(1, 2)))
(Note("af'4"), Timespan(start_offset=Offset(1, 2), stop_offset=Offset(3, 4)))
(Rest('r8'), Timespan(start_offset=Offset(1, 2), stop_offset=Offset(5, 8)))
(Note('e8'), Timespan(start_offset=Offset(5, 8), stop_offset=Offset(3, 4)))
(Note("af'4."), Timespan(start_offset=Offset(3, 4), stop_offset=Offset(9, 8)))
(Rest('r4'), Timespan(start_offset=Offset(3, 4), stop_offset=Offset(1, 1)))
(Note('g4'), Timespan(start_offset=Offset(1, 1), stop_offset=Offset(7, 6)))
(Note("g'8"), Timespan(start_offset=Offset(9, 8), stop_offset=Offset(5, 4)))
(Note('fs4'), Timespan(start_offset=Offset(7, 6), stop_offset=Offset(4, 3)))
(Note("c''8"), Timespan(start_offset=Offset(5, 4), stop_offset=Offset(11, 8)))
(Note('e8'), Timespan(start_offset=Offset(4, 3), stop_offset=Offset(17, 12)))
(Note("b'4."), Timespan(start_offset=Offset(11, 8), stop_offset=Offset(7, 4)))
(Note('cs8'), Timespan(start_offset=Offset(17, 12), stop_offset=Offset(3, 2)))
(Rest('r4.'), Timespan(start_offset=Offset(3, 2), stop_offset=Offset(15, 8)))
(Note("b'8"), Timespan(start_offset=Offset(7, 4), stop_offset=Offset(15, 8)))
(Rest('r16'), Timespan(start_offset=Offset(15, 8), stop_offset=Offset(31, 16)))
(Note('fs8'), Timespan(start_offset=Offset(15, 8), stop_offset=Offset(2, 1)))
(Note("d''16"), Timespan(start_offset=Offset(31, 16), stop_offset=Offset(2, 1)))
\end{lstlisting}
\end{singlespacing}
\end{abjadbookoutput}
