...
>>> show(measure)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-774102cf7b91119d6d9bb4b6b75ac925.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
...
Note("c'4")
Tuplet(Multiplier(2, 3), "a'4 { 4/5 b'8 a'8 g'8 f'8 e'8 }")
Chord("<d' f' a'>4")
\end{lstlisting}
\end{singlespacing}
\end{abjadbookoutput}
...
Tuplet(Multiplier(4, 5), "b'8 a'8 g'8 f'8 e'8")
Tuplet(Multiplier(2, 3), "a'4 { 4/5 b'8 a'8 g'8 f'8 e'8 }")
Measure((4, 4), "c'4 { 2/3 a'4 { 4/5 b'8 a'8 g'8 f'8 e'8 } } <d' f' a' c''>4")
\end{lstlisting}
\end{singlespacing}
\end{abjadbookoutput}

\subsection{Component duration}
