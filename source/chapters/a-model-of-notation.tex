...
\begin{lstlisting}
>>> print(foo)
<__main__.Foo object at 0x10394a810>
\end{lstlisting}
\begin{lstlisting}
>>> repr(foo)
'<__main__.Foo object at 0x10394a810>'
...
A \texttt{Spanner} can be attached to the leaves of the staff. Note that while
...
The spanner can also be detached again and reattached to a selection created by
...
container. Why attach spanners to containers at all?
