...
-   Discuss boilerplate from Tenor 2015 paper.

-   Abjad is not a stand-alone application, Abjad extends Python.

-   Abjad extends Python with an object-model of musical notation, and with a
    collection of classes and functions for modeling musical concepts and
    operations on musical objects.

-   Demonstrate the extent of Abjad's library.
