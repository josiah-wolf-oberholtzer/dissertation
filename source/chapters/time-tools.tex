...
>>> show(timespan)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-05809ae7a81b0fb2433591be32607181.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
\begin{singlespacing}
\vspace{-0.5\baselineskip}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-46be4544871ad44bf0fbd5b2d540b4e0.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2f656dbdec09167712bdf4582f008215.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2eb24ce655399fc3046bddefd4ee00f7.pdf}
\begin{minted}{pycon}
>>> timespan_inventory.all_are_contiguous
False
\end{minted}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a1c12d89a8b9c91d480abba32e96e2dc.pdf}
\begin{minted}{pycon}
>>> timespan_inventory.all_are_contiguous
True
\end{minted}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-7c7fbf8d84f2126064f0635aa9f7b2dc.pdf}
\begin{minted}{pycon}
>>> timespan_operand = timespantools.Timespan(6, 10)
>>> result = timespan_inventory & timespan_operand
>>> show(result, range_=(-2, 16))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-0fae3f5a6fe80da48374ca36bb834234.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2e623740e7da40730874da101ce7cb01.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-074092eb387634e20a090391091d0211.pdf}
\begin{minted}{pycon}
>>> left, right = timespan_inventory.split_at_offset(4)
>>> show(left, range_=(0, 10))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f1df3316976b680b06b34e57dd7c9b67.pdf}
\begin{minted}{pycon}
>>> show(right, range_=(0, 10))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b0b4ea22c46981a18b6afe50b6fcdd20.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
...
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-d04f11f64b7339eacb73fa961aa1fda8.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-730c4f4e0cea71276fdf997a39df6a4e.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-57c81baa0f9373bcf8fe0c884b910646.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b927f5ca7988ca25d1e5f7a8eddeb3ad.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-da44eec919c9f855b8cdac159c5fb724.pdf}
\begin{minted}{pycon}
>>> result = timespan_inventory.compute_logical_or()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-732626bcd9add538ce56ad9c456f93cc.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a525be51f2425338cbbdb7238e2ba4ee.pdf}
\begin{minted}{pycon}
>>> result = timespan_inventory.compute_logical_and()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result, range_=(-2, 12))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-36707c8f5eee1f21f2f36d34af0ca735.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, range_=(-2, 12))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-a923eb4d200cefe6d44ed2800258c122.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-f088ae951e4c3b797a2899b3febc7f13.pdf}
\begin{minted}{pycon}
>>> for shard in timespan_inventory.partition():
...     show(shard, range_=(0, 30))
...
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-dabf1ac0fc44277c6c15b6564ed9cbde.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e6cd1e7ea0b9c56d6b9a676ee97e15d2.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-3de25fb8aa9f4a27f18e81b088631887.pdf}
\begin{minted}{pycon}
>>> for shard in timespan_inventory.partition(include_tangent_timespans=True):
...     show(shard, range_=(0, 30))
...
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-5b8deba769a4e54af9ef7260c65c36f4.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-3de25fb8aa9f4a27f18e81b088631887.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory)
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b64b5b3230721ad32fe21220479e9b08.pdf}
\begin{minted}{pycon}
>>> for shard in timespan_inventory.explode():
...     show(shard, range_=(-2, 20))
...
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-62c9390bf5a067707305398d0567d290.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-c429f2b829cb801098419217c335433c.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-96a540b5c0661e70ab8ad629ee644214.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-1c08de48332d145fe5161e21de5201c4.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-64e4c1a31ec022c11b4a1239375058f4.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
...
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-0c6170bdd6a5af615963601e9562d469.pdf}\\
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-b15ba27ffc7c7ac3cd8175ebf7f5dfbd.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4e7982fd6e82b0e6bce7298c4a334df8.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-31e8be4dacb46526044fd9dd74b9e057.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-64e84e1b5bd31c8714b052473ae3394f.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-3b3f1b99ef35d9c3d5248dd534298d27.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2975068cc50a0be81eca98215e71ee6e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-28cfdcef629853d17e700e6499df96a8.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-244b12c834767f1ee6ff65aa75a26bf9.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-e335a4b9080808b2bc75e427feb0a946.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-437376437a5c347835eb76a73c2e44d3.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-57a077185df7102e2725776d3bfc067e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-75d6d936576d790d92405072590451ab.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-9ea33611ee52cd7ee1567a9f63d156a2.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-1dd8eacde0e4f7b507275eef504d1b08.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-bb332487adfb197094489ddb943596f7.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-6736037628fb71d8ef1ad10277849494.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-cef02126ad1c2aaf19c885feadf1d607.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2b1d25d9c60136f8967163e8a44a4c1e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-6ae61f6ed7a83b1b30720afde3e988c3.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-daa860f77801b811b39079aff6ce1dc6.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(timespan_inventory, key='voice_name')
\end{minted}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-1aa50b273f0fe875eb2fa2112aa276cb.pdf}
\begin{minted}{pycon}
>>> score = build_score(
...     performed_rhythm_maker=performed_rhythm_maker,
...     permitted_meters=permitted_meters,
