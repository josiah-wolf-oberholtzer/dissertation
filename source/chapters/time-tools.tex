...
>>> show(timespan)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-fa85930d8e873f6b523722e207b97279.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
\begin{singlespacing}
\vspace{-0.5\baselineskip}
\noindent\includegraphics{assets/lilypond-a7b6f3bad945a3859499b0b31500de75.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-cd51129aa3072dd253c2f3f920f2d8b4.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-50859aa8333d9988b50e3fccebf11be2.pdf}
\begin{lstlisting}
>>> timespan_inventory.all_are_contiguous
False
\end{lstlisting}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-e5a925aff3202f905b9532d61dd48333.pdf}
\begin{lstlisting}
>>> timespan_inventory.all_are_contiguous
True
\end{lstlisting}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-f03d9fd71c4ad899a8bb8f97b96a9a20.pdf}
\begin{lstlisting}
>>> timespan_operand = timespantools.Timespan(6, 10)
>>> result = timespan_inventory & timespan_operand
>>> show(result, range_=(-2, 16))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-e790b64c1dc5367b01ea230836a1aebb.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-6dcf12333bdb56181f7236a3109169cd.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-c3109fc5942ffdc443243253758482c4.pdf}
\begin{lstlisting}
>>> left, right = timespan_inventory.split_at_offset(4)
>>> show(left, range_=(0, 10))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-5341bb96014dfee6108b9b855b132837.pdf}
\begin{lstlisting}
>>> show(right, range_=(0, 10))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-68cae7183705e574fda28b092d13fe3e.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
...
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-27e3402fed83b515745ada579251724c.pdf}\\
\noindent\includegraphics{assets/lilypond-6e7ebf85d2f18955a5f0abd3d7d8b313.pdf}\\
\noindent\includegraphics{assets/lilypond-8d75ab1d88dd566393ff3a9050dabef1.pdf}\\
\noindent\includegraphics{assets/lilypond-58563a29b41c2e27aecf0365da35f817.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-4033f9de9798fa5317729d4adc715949.pdf}
\begin{lstlisting}
>>> result = timespan_inventory.compute_logical_or()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-2dc98dc7d783a5fd65be90b471514f41.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-7c2b53f99dda26e827d1eeb63cd170a7.pdf}
\begin{lstlisting}
>>> result = timespan_inventory.compute_logical_and()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result, range_=(-2, 12))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-7e0ece5fbe36aa69b1883f0464594b55.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, range_=(-2, 12))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-174c4b448bdac5c38814b4909b83fc5d.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-820a78450aab6a5346d9c3b3467f8be7.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.partition():
...     show(shard, range_=(0, 30))
...
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-89b60b1658b6f2641b6572265b982f73.pdf}\\
\noindent\includegraphics{assets/lilypond-73e111b7a59aab69115dc098c4bd0817.pdf}\\
\noindent\includegraphics{assets/lilypond-3afca9df70b2a5721107cf7e87037218.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.partition(include_tangent_timespans=True):
...     show(shard, range_=(0, 30))
...
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-eaeaa38d9352d3d1f125c3dce8b7f595.pdf}\\
\noindent\includegraphics{assets/lilypond-3afca9df70b2a5721107cf7e87037218.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(even_division_rhythm_maker, divisions=divisions)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-06c5f723997363adb1e3e9391d01892a.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
