...
\emph{\index{timespan}} object suggests a \enquote{coarse} approach to musical time.
...
Annotated \index{timespan}s allow composers to position metadata anywhere on a
timeline, much like arranging audio regions in a DAW. Moreover, every durated
object in a score hierarchy can be described as a \index{timespan}, allowing score
...
rhythmic interpretation. Meter sequences can be generated from \index{timespan}-based
...
absolutely along a timeline. This means that every \index{timespan} describes an
...
>>> show(incised_rhythm_maker, divisions=divisions)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-d22f16b98a9a0b7dc379c37be145f71f.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-24f1ff3921c0157e59a866cabd4691e3.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
