...
rhythm-maker which attempts to fill each output division with a run of 1/8
notes, every other division is extended by one count, causing the 4/8 and 2/4
...
>>> graph(six_eight_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-def059788733b2da292c28ae106a47f5.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(three_four_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-7e2283286be19b5809bee13cf64d83ee.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(seven_eight_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-471b95516a5478acd802a75bc0f152fc.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(twelve_eight_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-58c5711f30ce38a0be0ec2aad3b65181.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(four_four_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-12601707db5ddc467e3296e8c680ba43.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(arbitrary_meter_1)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-24dec0c4fa2e028c1bffb9c05dbc48a3.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(arbitrary_meter_2)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-dd9099ec3dbba4936095eec5d635cc0d.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> graph(nine_eight_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.5]{assets/graphviz-18bdc18e7331fb0ae5a23dce68bb4246.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2500c663b213c7796262897a01895f66.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-18f723f2072c91b3dec5951e986fa83e.pdf}
\end{singlespacing}
\end{abjadbookoutput}
