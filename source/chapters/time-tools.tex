...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-cf1cdd48611ac4f872c5b487b4105d41.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-28dc6b5bbc8d9f63b1a17970c4f2f8ee.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-d7799e9481346f54b40208d29723a2dd.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-089ad1538429a47769793da996bae0c3.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-1c103bdad2e02d823f99fa27e0b822a2.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-0fc4f5156675db2877a09433bc0db9bf.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-60519c923ef41d6b01828cfc343d5e7a.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-14091c11e174426073642e39e1b2c87e.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
