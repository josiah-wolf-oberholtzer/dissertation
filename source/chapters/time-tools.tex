...
>>> graph(twelve_eight_meter)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,scale=0.6]{assets/graphviz-c2a676a2bd53c91042417caefc7efaa9.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
of the misaligned 1/8:5/8 logical tie: 3/8.
