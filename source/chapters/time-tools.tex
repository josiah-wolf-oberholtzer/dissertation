...
notational reality. Timespans may be annotated, allowing composers to position
...
of rhythmic generation. Meter coordinates time and rhythm vertically across
score hierarchy, and bridges the coarse and fine stages of rhythmic
interpretation. Meter sequences can be generated from \index{timespan}-based
phrase structures, and those meter sequences used to transform notated rhythms
in turn. A thorough discussion of the implementation of these time models and
...
interpretation algorithm -- timespan consolidation, cascading overlap
...
logical tie at 1/4 and 3/4, slightly improving readibility.
...
\begin{markdown}
-   Recapitulate introduction
    -   Timespan provide a coarse-grained model
    -   Rhythm -- *music* -- provides a fine-grained model
    -   Meter can be derived from one and applied to the other
    -   Timespans exist without score
    -   Rhythm exists with score
    -   Factories can be used to programmatically generate either
    -   All can be used together to generate rich scores
-   Discuss patterns and randomness
