...
>>> show(timespan)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-3197d8ddef560bdde0c460c116b33801.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
\begin{singlespacing}
\vspace{-0.5\baselineskip}
\noindent\includegraphics{assets/lilypond-2bec073ccb80642bed69b2ea98034628.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-334f7faa0ec05aeb7fa5ff0a1269aca8.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-a70ee4d73e99262ce1f5b0d756fdd03b.pdf}
\begin{lstlisting}
>>> timespan_inventory.all_are_contiguous
False
\end{lstlisting}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-b3f55aeb2663321d68249a5274bfbcd4.pdf}
\begin{lstlisting}
>>> timespan_inventory.all_are_contiguous
True
\end{lstlisting}
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-9b42007deeb7b033ec210fb673117f16.pdf}
\begin{lstlisting}
>>> timespan_operand = timespantools.Timespan(6, 10)
>>> result = timespan_inventory & timespan_operand
>>> show(result, range_=(-2, 16))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-780a4eb96f5a2ab70bd4ee332cb4121f.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-093cdaf46f6b94446ef82999702eda1c.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-dc1472aa97e4c5d099167a69c04c00f6.pdf}
\begin{lstlisting}
>>> left, right = timespan_inventory.split_at_offset(4)
>>> show(left, range_=(0, 10))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-316a5eb07621d2627596f5326675ad66.pdf}
\begin{lstlisting}
>>> show(right, range_=(0, 10))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-d06f648bf6c12655be313c93786f9531.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
...
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-352a5111f35bca1be6c7ff229f3ccf80.pdf}\\
\noindent\includegraphics{assets/lilypond-9a4dc172fcf9ff904688085a13b8056c.pdf}\\
\noindent\includegraphics{assets/lilypond-5d9e98d9c3963af4d0e090991c6f03f1.pdf}\\
\noindent\includegraphics{assets/lilypond-430eaccdb8c664619fba4358c2edaec4.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-ddb69738dd7250f40ad276ee1dd102e0.pdf}
\begin{lstlisting}
>>> result = timespan_inventory.compute_logical_or()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-3f810a28d4b1a316daea09727ada2da7.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-e523698cbed9e80d8d2d668c81490c34.pdf}
\begin{lstlisting}
>>> result = timespan_inventory.compute_logical_and()
>>> print(format(result))
timespantools.TimespanInventory(
...
>>> show(result, range_=(-2, 12))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-6c46cea5de76a50856a8dcc8e4ac39c2.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, range_=(-2, 12))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-579456be41236bcc4c6f3ef2d8b96dad.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-529696911567b1b55dfc7ba216d6e59d.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.partition():
...     show(shard, range_=(0, 30))
...
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-d6ab9da0c9636474e745d5612bb7bbbb.pdf}\\
\noindent\includegraphics{assets/lilypond-b9c1bfc79717ac2213b1c37e123446e9.pdf}\\
\noindent\includegraphics{assets/lilypond-0ab1942bf11e9b386e0aafdb9cd22edb.pdf}
\begin{lstlisting}
>>> for shard in timespan_inventory.partition(include_tangent_timespans=True):
...     show(shard, range_=(0, 30))
...
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-fa4b2285bd55e802c98578492760a139.pdf}\\
\noindent\includegraphics{assets/lilypond-0ab1942bf11e9b386e0aafdb9cd22edb.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-f746878bb77dae0baec37bbeb02cb34f.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-b922fd9d63818b0a3f22a0377c8e95d3.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-ebfd8c880740e50dc088f6304e30f973.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-a6702ee36d43cf93ba5728eaa6773fd1.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-7f1b78377186311548aec873e02a00b0.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-e7f5987861858d91a2809a56e791d1d1.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-78aaaa427152e614120861752f4366e1.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-54d2fa8b64e488a84ee52a488caf28df.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-780df86ad9a6fb2424e5754f4ed917da.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-d2009fad335e628aa2ba715e8ff1bc54.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(timespan_inventory, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-eb404e54d3ebc0572accd8a112c8a91d.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-6ffefd8f2dd016f323845a247a09e47b.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-eeed8706ccb6d7342d56cdc6ab7157a9.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-5619e308cbfc5699e3edcba3dfd3a38a.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name')
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-522aad3db291ec1d132b81809b3f61b1.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-09c9f5e5d3438489254c9892b37f5275.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-8f57841e365408f4a261dbf35a36f4d8.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(result, key='voice_name', range_=(0, 75))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-ce6ad1aa702d5fe6c7f2fa0d713bb0ea.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(six_eight_meter)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-476d0f5c7605cc762b9e3a391835548f.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(three_four_meter)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-27e6f78f37c92f763186b4aaae59c563.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(seven_eight_meter)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-aa33afdcb82327be8e33e7587b5b7fb5.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(twelve_eight_meter)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-c2a676a2bd53c91042417caefc7efaa9.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(four_four_meter)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-1e7a83f7d35a8732ccfa1919e9c8f64f.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(arbitrary_meter_1)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-538350f4d574238c7fe14b0bc2fcd602.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(arbitrary_meter_2)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-c0c488f838ef576f45131546e93310fa.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> graph(nine_eight_meter)
\end{lstlisting}
\noindent\includegraphics[scale=0.333]{assets/graphviz-9a650c94101f81b5350bc7b0edcf43a1.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(offset_counter, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-c74006582b28efb1d61d9a6f219c91c8.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(permitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-e862fa00da35d33ab02699b7f058c648.pdf}
\begin{lstlisting}
>>> fitted_meters = metertools.Meter.fit_meters_to_expr(
...     expr=offset_counter,
...     meters=permitted_meters,
...
>>> show(fitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-96511fa6cd9448347d5f584042ff653c.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(offset_counter, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-51cf25a6929362a969d24f3932cb3e52.pdf}
\begin{lstlisting}
>>> show(fitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-dd55e0279284ea18fd6b62df64b34865.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(fitted_meters, range_=(0, 5))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-ab7c3eddad3d28cb19706ae50e024b17.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-4252566a868aa8669a597a9b20a09b83.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-9a5158818ad5fbad7bdb5f19fd966315.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-4dea6222540afc3cf0b84d79ca2bc728.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-a1f558ce38e84f316c17684a30bd0fac.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(poorly_fitted_meters, range_=(0, (19, 4)))
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-78da5486599d2faeead3b3ce63e0ba05.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
-   Meter fitting often emphasizes local maxima while missing larger patterns
-   It is a kind of constraint problem
-   Improvements might include increasing lookahead....
-   Testing for start offsets preceded by silences...
-   Changing the weighting algorithm for metric accent kernels...
-   Or jumping to offsets with high weights and solving away from them.
-   However, such "jump-forward" could result in good partial solutions which
    cannot sum backwards to the initial downbeat (because no combination of
    permitted meter will sum that way).
-   In any case, it requires human fine tuning.
\end{markdown}
...
- Create a timespan inventory
- Fit meters against it
- Explode by voice name
- Partition by contiguity
- Split shards by meter boundaries
- Populate score
\end{markdown}
...
def build_score(
    ...
    for voice in iterate(score).by_class(Voice):
        voice_timespans = timespantools.TimespanInventory([
            _ for _ in timespan_inventory if _.voice_name == voice.name
            ])
        ...
        if previous_stop_offset != timespan_inventory.stop_offset:
            silence_music = make_silence_music(
                meter_boundaries=meter_boundaries,
                start_offset=previous_stop_offset,
                stop_offset=timespan_inventory.stop_offset,
                )
            voice.append(silence_music)
    return score
</abjad>
...
Timespan annotations allow for maquette-like composition techniques, or working
in a way that conceptually mirrors working with a DAW, even though there is no
real graphic output except for notation itself.
