...
timespans, timespans themselves do not -- by definition -- refer to any score
...
data structure like a dictionary, that annotation can be used to store
...
aggregated in a data structure called a \emph{timespan inventory}, which is
