...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-4cc99eb25ad6bff16e0d80e74536a91c.pdf}
\end{singlespacing}
\end{abjadbookoutput}
...
>>> show(score)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-9a60e0606f9bf6de2f325689ff40447b.pdf}
\end{singlespacing}
\end{abjadbookoutput}
