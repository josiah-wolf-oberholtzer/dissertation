...
within a single voice. Music settings object-model both \emph{when} and in
...
Discuss music specifiers.

Discuss grace, pitch and attachment handlers.

Discuss why graces happen later.

Discuss pitch specifiers, pitch operation specifiers, logical tie expressions.

Discuss attachment expressions and selector.
...
\subsection{Evaluating music settings}
...
of procedural timespan identifiers such as \emph{ratio-parts expressions} which
must be called against a preexisting timespan in order to determine what part
or parts of that timespan to use -- the music setting must resolve its timespan
