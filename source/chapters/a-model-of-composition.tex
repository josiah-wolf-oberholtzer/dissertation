...
>>> show(illustration)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-2cd152c8ae7c36e9c4d25794d6a5c01e.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> for index, key_value_pair in enumerate(segment_maker.attack_point_map.items()):
...     logical_tie, attack_point_signature = key_value_pair
...     index_markup = Markup(index, Up).tiny().box()
...     attach(index_markup, logical_tie.head)
...
>>> show(illustration)
\end{lstlisting}
\noindent\includegraphics[max width=\textwidth,]{assets/lilypond-c1fbf923c4cbc77d42a8ea568c3536b5.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
