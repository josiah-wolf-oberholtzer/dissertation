...
Consort models composition through the *specification* of how *out-of-time
materials* -- both concrete and programmatic -- should be deployed *in-time* on
the page as notation.

Consort works with *segments* of score, 
