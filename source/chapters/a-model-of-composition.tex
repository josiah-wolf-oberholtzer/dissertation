...
other_music_specifier = consort.MusicSpecifier(
    pitch_handler=consort.AbsolutePitchHandler(pitch_specifier='g'),
    )
...
>>> show(segment_maker, verbose=False)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-a920fdb8f9a198e7d6f0f97807e2233d.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(segment_maker, verbose=False)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-29a675015a2a700762e4119b2677a4f5.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(segment_maker, verbose=False)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-9586324006f92771677cf0f7e8ac5acc.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(segment_maker, verbose=False)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-e907b0740dce58f759bb3150bbd5add0.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%
...
>>> show(segment_maker, verbose=False)
\end{lstlisting}
\noindent\includegraphics{assets/lilypond-83fe3282afc48176469394112586e7ea.pdf}
\end{singlespacing}
%%% ABJADBOOK END %%%