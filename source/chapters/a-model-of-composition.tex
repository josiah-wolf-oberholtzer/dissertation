...
a target timespan of \sfrac[big]{6}{4} to \sfrac[big]{21}{4}. While -- due to the
...
\sfrac[big]{21}{4}, it will certainly not contain any performed or silent timespans
earlier than \sfrac[big]{6}{4}, leaving lower layers untouched from \sfrac[big]{0}{1} to
\sfrac[big]{6}{4}:
